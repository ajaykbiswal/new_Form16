...
import java.io.FileOutputStream;
	...
	public class Xl extends TestBase
	{
	  ...
	  public static void generateReport(String xlFileName)
	    throws Exception
	  {
	  ...
	  public static void generateReport(String folderLocation, String xlFileName)
	    throws Exception
	  {
	    String path = System.getProperty("user.dir") + "/test-output/";
	    File xmlFile = new File(path + "testng-results.xml");
	  ...
	  private static void applyCellHeaderStyle(short index)
	  {
	    ...
	    headerFont.setFontHeight(10.0D);
